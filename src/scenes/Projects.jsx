...
const images = [
  ...
  { src: "project-11.png", description: "Nostal", alt: "Nostal" },
  { src: "project-12.png", description: "Awashop", alt: "Awashop" },
  { src: "project-13.jpg", description: "Form", alt: "Form" },
  { src: "project-14.png", description: "News Website", alt: "News Website" },
  {
    src: "project-15.png",
